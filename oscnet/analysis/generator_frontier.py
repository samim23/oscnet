...
DEFAULT_VARIANT_PATTERNS = (
    ...
    re.compile(r"cifar10_rgb_coarse_objective_(.+?)_n256"),
    re.compile(r"cifar10_rgb_feedback_signal_(.+?)_n256"),
    re.compile(r"cifar10_rgb_feedback_source_gate_(.+?)_n256"),
    re.compile(r"cifar10_rgb_feedback_source_mix_(.+?)_n256"),
    re.compile(r"cifar10_rgb_vertical_gain_target_(.+?)_n256"),
    re.compile(r"cifar10_rgb_vertical_timing_(.+?)_n256"),
    re.compile(r"cifar10_rgb_vertical_homeostasis_(.+?)_n256"),
    re.compile(r"cifar10_rgb_dual_gain_(.+?)_n256"),
    re.compile(r"cifar10_rgb_vertical_calibration_(.+?)_n256"),
    re.compile(r"cifar10_rgb_vertical_causality_(.+?)_n256"),
    re.compile(r"cifar10_rgb_multiscale_soft_gate_(.+?)_n256"),
    re.compile(r"cifar10_rgb_multiscale_signed_gain_(.+?)_n256"),
    re.compile(r"cifar10_rgb_multiscale_weak_drive_(.+?)_n256"),
    re.compile(r"cifar10_rgb_multiscale_gain_(.+?)_n256"),
    re.compile(r"cifar10_rgb_multiscale_gated_(.+?)_n256"),
    re.compile(r"cifar10_rgb_multiscale_auxiliary_(.+?)_n256"),
